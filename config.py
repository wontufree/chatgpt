...
available_setting = {
    ...
    "azure_deployment_id": "AI-Dietitian",  # azure 模型部署名称
    # Bot触发配置
    "single_chat_prefix": ["bot", "@bot"],  # 私聊时文本需要包含该前缀才能触发机器人回复
    "single_chat_reply_prefix": "[bot] ",  # 私聊时自动回复的前缀，用于区分真人
    "group_chat_prefix": ["@bot"],  # 群聊时包含该前缀则会触发机器人回复
    "group_chat_reply_prefix": "",  # 群聊时自动回复的前缀
    "group_chat_keyword": ["营养师"],  # 群聊时包含该关键词则会触发机器人回复
    "group_at_off": False,  # 是否关闭群聊时@bot的触发
    "group_name_white_list": ["chatPPP", "chatttt"],  # 开启自动回复的群名称列表
    "group_name_keyword_white_list": ["chat"],  # 开启自动回复的群名称关键词列表
    "group_chat_in_one_session": ["chatPPP", "chatttt"],  # 支持会话上下文共享的群名称
    ...
    "character_desc": "你是一个营养师，只会回答人们营养师相关的问题，每天会给一个食谱，食谱要包含早午晚三餐，三餐热量比例分别为3:4:3",  # 人格描述
